  ...
  return (
    <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
      <div className="mt-20 flex max-w-2xl flex-col gap-5">
            <h1 className="pb-10 text-4xl font-bold tracking-tight text-gray-700 sm:text-5xl">
              <u>Estructura 205:</u>
            </h1>
      </div>
...
function BlurImage({ image }: { image: Image }) {
  ...
  return (
    <a href={image.href} className="group">
      <div className="aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-lg bg-gray-200 xl:aspect-w-7 xl:aspect-h-8 shadow-lg border-solid border border-slate-200">
        <Image
          alt=""
          src={image.imageSrc}
          layout="fill"
